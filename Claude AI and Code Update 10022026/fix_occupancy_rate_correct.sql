-- =====================================================
-- FIX: Occupancy rate based on months WITH bookings × 31 days
-- Formula: total_nights / (months_with_bookings × 31)
-- Example 2026: 80 nights / (9 months × 31) = 28.67%
--
-- Logic: Count DISTINCT months that have bookings,
-- then multiply by 31 to get available nights
-- =====================================================
