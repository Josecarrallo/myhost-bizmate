...
## ARQUITECTURA CONCEPTUAL (CRÍTICO)

```
AUTOPILOT = INTERFAZ (vista simple para owners)
     ↓
MY HOST BizMate = CEREBRO + MOTOR (Supabase + n8n + AI)
```

**AUTOPILOT NO es un sistema nuevo. Es la UI de BizMate.**

### Menú AUTOPILOT (9 secciones)
| # | Sección | Backend | Objetivo |
|---|---------|---------|----------|
| 1 | Setup & Data Entry | Supabase | "Aquí meto mis datos" |
| 2 | Availability & Channels | Supabase + futuro | "Veo disponibilidad" |
| 3 | Bookings | bookings ✅ | "Mis reservas" |
| 4 | Payments | WF-D2 ✅ | "Controlo el dinero" |
| 5 | Guest Communication | BANYU ✅ | "No pierdo mensajes" |
| 6 | My Villa Website | ⏳ Landing | "Mi web para clientes" |
| 7 | Maintenance & Tasks | ⏳ Nueva tabla | "Operación diaria" |
| 8 | Overview | OSIRIS ✅ | "Cómo va el negocio" |
| 9 | Owner Decisions | autopilot_actions ✅ | "Decido cuando toca" |

**Visión:** *"Lo que hago cada día/semana/mes, organizado y automatizado."*
