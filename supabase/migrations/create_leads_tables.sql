...
CREATE TABLE IF NOT EXISTS lead_events (
  ...
  -- Metadata
  created_at TIMESTAMPTZ DEFAULT NOW(),
  created_by TEXT -- system, ai, user_id
);
...
-- Grant access to authenticated users (adjust as needed for RLS)
...
BEGIN
  ...
  RAISE NOTICE '📝 Next step: Configure Row Level Security (RLS) policies if needed';
END $$;
