-- ========================================================================
-- AI ASSISTANT TABLES - OPCIÓN C (Híbrido) - FORCE RECREATE VERSION
-- Created: 26 DIC 2025
...
-- ========================================================================
-- 3. CREATE AI CHAT HISTORY TABLE
-- ========================================================================
...
CREATE INDEX idx_ai_runs_provider ON public.ai_runs(provider);
...
-- ========================================================================
-- 7. CREATE KPI FUNCTIONS
-- ========================================================================

-- Calculate occupancy rate for a tenant in a date range
CREATE FUNCTION public.calculate_occupancy_rate(
  p_tenant_id UUID,
  p_date_from DATE,
  p_date_to DATE
)
...
CREATE FUNCTION public.calculate_total_revenue(
  p_tenant_id UUID,
  p_date_from DATE,
  p_date_to DATE
)
...
CREATE FUNCTION public.calculate_adr(
  p_tenant_id UUID,
  p_date_from DATE,
  p_date_to DATE
)
...
-- 8. VERIFICATION
-- ========================================================================
SELECT 'AI Assistant schema created successfully!' as status;

-- Show created tables
SELECT tablename as created_tables
FROM pg_tables
WHERE schemaname = 'public'
AND (tablename LIKE 'ai_%' OR tablename = 'alerts' OR tablename = 'audit_logs')
ORDER BY tablename;

-- Show created functions
SELECT proname as created_functions
FROM pg_proc
