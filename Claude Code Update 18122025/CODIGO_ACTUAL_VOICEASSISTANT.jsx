// VoiceAssistant.jsx - CÓDIGO ACTUAL (18 DIC 2025 - 13:50)
// Ubicación: C:\myhost-bizmate\src\components\VoiceAssistant\VoiceAssistant.jsx
// Estado: ⚠️ Botón aparece pero muestra error al conectar
  ...
  const handleStartCall = async () => {
    ...
    try {
      await vapiRef.current.start({
        assistantId: '1b8348c7-cfbc-442a-821f-c9aaf96d1ba7' // ⚠️ VERIFICAR SI ESTE ES EL ID CORRECTO
      });
    } catch (error) {
