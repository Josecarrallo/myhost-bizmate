    ...
    <div className="min-h-screen bg-[#2a2f3a] p-4 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="p-3 bg-[#1f2937]/95 backdrop-blur-sm rounded-2xl hover:bg-[#1f2937] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 border-2 border-[#d85a2a]/20">
            <Download className="w-6 h-6 text-[#FF8C42]" />
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
          <div className="bg-[#1f2937]/95 backdrop-blur-sm rounded-2xl p-5 shadow-xl border-2 border-[#d85a2a]/20">
            ...
            <p className="text-3xl font-black text-[#FF8C42]">{upcomingArrivals.length}</p>
          </div>
          <div className="bg-[#1f2937]/95 backdrop-blur-sm rounded-2xl p-5 shadow-xl border-2 border-[#d85a2a]/20">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl">
        ...
        <div className="space-y-6">
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="bg-[#1f2937]/95 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border-2 border-[#d85a2a]/20">
              <h3 className="text-2xl font-black text-[#FF8C42] mb-6">Upcoming Arrivals (Next 7 Days)</h3>
                  ...
                  <div key={guest.id} className="bg-gray-50 rounded-2xl p-4 border-2 border-gray-200 hover:shadow-lg transition-all">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h4 className="text-lg font-black text-[#FF8C42] mb-1">{guest.name}</h4>
            ...
            <div className="space-y-4">
              {/* QR Code */}
              <div className="bg-[#1f2937]/95 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border-2 border-[#d85a2a]/20 text-center">
                <h3 className="text-xl font-black text-[#FF8C42] mb-4">QR Check-in Code</h3>
              ...
              <div className="bg-[#1f2937]/95 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border-2 border-[#d85a2a]/20">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-xl border-2 border-orange-100">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-[#FF8C42]">Complete Digital Form</div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-xl border-2 border-orange-100">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-[#FF8C42]">Receive Access Code</div>
                  ...
                  <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-xl border-2 border-orange-100">
                    ...
                    <div className="flex-1">
                      <div className="font-bold text-[#FF8C42]">Self Check-in</div>
      ...
      {selectedGuest && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setSelectedGuest(null)}>
          <div className="bg-[#1f2937] rounded-3xl max-w-2xl w-full shadow-2xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="col-span-2">
                    ...
                    <p className="font-bold text-[#FF8C42] text-lg">{selectedGuest.nights} nights</p>
                  </div>
                </div>
              </div>
              ...
              {selectedGuest.accessCode && (
                <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white border-4 border-orange-300">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm opacity-90 font-semibold bg-[#d85a2a]/10 rounded-xl p-3">
