  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        {/* Title - Spanish */}
        <h2 className="text-2xl md:text-3xl font-semibold text-[#d85a2a] mb-2">
          Habla con KORA
        </h2>

        {/* Title - Indonesian */}
        <h2 className="text-2xl md:text-3xl font-semibold text-[#d85a2a] mb-6">
          Bicara dengan KORA
        </h2>
...
export default PublicVoicePage;
